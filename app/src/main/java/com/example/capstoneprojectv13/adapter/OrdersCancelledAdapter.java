...
import com.example.capstoneprojectv13.CancelledActivity;
...
public class OrdersCancelledAdapter extends FirebaseRecyclerAdapter<OrdersModel, OrdersCancelledAdapter.myViewHolder> {
    /**
    ...
    public OrdersCancelledAdapter(Context context, @NonNull FirebaseRecyclerOptions<OrdersModel> options) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull OrdersCancelledAdapter.myViewHolder holder, int position, @NonNull OrdersModel model) {
        ...
        holder.OrdersBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, CancelledActivity.class);
    ...
    @NonNull
    @Override
    public OrdersCancelledAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View ordersLayout = LayoutInflater.from(parent.getContext()).inflate(R.layout.users_order,parent,false);
        return new OrdersCancelledAdapter.myViewHolder(ordersLayout);
    }
