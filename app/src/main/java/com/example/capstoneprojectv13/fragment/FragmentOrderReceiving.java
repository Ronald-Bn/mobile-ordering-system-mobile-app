 ...
 * Use the {@link FragmentOrderReceiving#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentOrderReceiving extends Fragment {
     ...
     * @return A new instance of fragment FragmentOrderReceiving.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentOrderReceiving newInstance(String param1, String param2) {
        FragmentOrderReceiving fragment = new FragmentOrderReceiving();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_order_receiving, container, false);
        ...
        Query query = FirebaseDatabase.getInstance("https://capstone-project-v-1-3-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference()
                .child("Orders").orderByChild("status_userid").equalTo("receiving_" + user.getUid());
