 ...
 * Use the {@link FragmentOrderShipping#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentOrderShipping extends Fragment {
     ...
     * @return A new instance of fragment FragmentOrderShipping.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentOrderShipping newInstance(String param1, String param2) {
        FragmentOrderShipping fragment = new FragmentOrderShipping();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Query query = FirebaseDatabase.getInstance("https://capstone-project-v-1-3-default-rtdb.asia-southeast1.firebasedatabase.app/")
                .getReference()
                .child("Orders")
                .orderByChild("status_userid")
                .equalTo("shipping_" + user.getUid());
